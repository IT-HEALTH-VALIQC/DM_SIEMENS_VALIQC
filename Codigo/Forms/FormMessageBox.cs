...
namespace APP_ADM_SIEMENS_VALIQC.Forms
{
    public partial class FormMessageBox : Form
    {
        ...
        private void SetButtons(MessageBoxButtons buttons, MessageBoxDefaultButton defaultButton)
        {
            ...
            switch (buttons)
            {
                case MessageBoxButtons.OK: //En uso para los mensajes OK y los de error
                    //OK Button
                    ...
                    //if (labelCaption.Text.Equals("OK"))
                    //{
                    //    //Colores
                    //    panelTitleBar.BackColor = Color.FromArgb(75, 216, 214);
                    //    BackColor = Color.FromArgb(75, 216, 214);
                    //    button1.BackColor = Color.FromArgb(75, 216, 214);
                    //}
                    //if (labelCaption.Text.Equals("ERROR"))
                    //{
                    //    //Colores
                    //    panelTitleBar.BackColor = Color.FromArgb(199, 119, 122);
                    //    BackColor = Color.FromArgb(199, 119, 122);
                    //    button1.BackColor = Color.FromArgb(199, 119, 122);
                    //}
                    //if (labelCaption.Text.Equals("INFORMACIÓN"))
                    //{
                    //    //Colores
                    //    panelTitleBar.BackColor = Color.FromArgb(242, 208, 63);
                    //    BackColor = Color.FromArgb(242, 208, 63);
                    //    button1.BackColor = Color.FromArgb(242, 208, 63);
                    //}
                ...
                case MessageBoxButtons.YesNo: //En uso para los mensajes de advertencia

                    //if (labelCaption.Text.Equals("ADVERTENCIA"))
                    //{
                    //    //Colores
                    //    panelTitleBar.BackColor = Color.FromArgb(124, 136, 224);
                    //    BackColor = Color.FromArgb(124, 136, 224);
                    //    button1.BackColor = Color.FromArgb(199, 119, 122);
        ...
        private void SetIcon(MessageBoxIcon icon)
        {
            switch (icon)
            {
                ...
                case MessageBoxIcon.Information: //Information
                    this.pictureBoxIcon.Image = Properties.Resources.Esperando;
                    PrimaryColor = Color.FromArgb(38, 191, 166);
                    break;
                case MessageBoxIcon.Question://Question
                    this.pictureBoxIcon.Image = Properties.Resources.Interpretando;
